...
//        Recipe.addProductInRecipe(salt, 1);
        ...
        System.out.println();
        System.out.println("ДЗ 3. Задание 2. В классе Multiplication");
        ...
        System.out.println();
        System.out.println("Коллекции. ДЗ 1. Задание 1.");

        Map<String, String> manPhone = new LinkedHashMap<>();
        ...
        for (Map.Entry<String, String> contact: manPhone.entrySet()) {
            System.out.println("Абонент " + contact.getKey() + ": тел. " + contact.getValue());
        }

        System.out.println();
        System.out.println("Коллекции. ДЗ 1. Задание 2.");
//
        ...
        System.out.println();
        System.out.println("Коллекции. ДЗ 1. Задание 3. В Классе Training");

        System.out.println();
        System.out.println("Коллекции. ДЗ 2. Задание 1. в  Классе MapTest");

        System.out.println();
        System.out.println("Коллекции. ДЗ 2. Задание 2.");
